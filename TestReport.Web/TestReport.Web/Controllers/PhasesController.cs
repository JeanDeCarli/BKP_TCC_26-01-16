...
namespace TestReport.Web.Controllers
{
    ...
    public class PhasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,startDate,endDate")] Phase phase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,startDate,endDate")] Phase phase)
        {
            if (ModelState.IsValid)
            {
